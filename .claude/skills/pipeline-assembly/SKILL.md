...
description: 链路拼接与壳代码编写知识库入口 —— UMVP 链路组成环节的全部所需知识（系统介绍、模块速查、链路决策、壳代码骨架、拼装套路、常见坑、已验证/未验证清单）。当需要"把业务需求组装成可运行管道"、"写拼接层/测试壳/胶水文件"、"选四模式之一"、"给链路建议或资源估算"时使用。总装/组装工两个 agent 的知识来源。
user-invocable: true
---
